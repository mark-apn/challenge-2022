...
const PointerSettingsMessage_PointerShape$json = const {
  ...
  '2': const [
    ...
    const {'1': 'POINTER_SHAPE_PEACE', '2': 3},
    const {'1': 'POINTER_SHAPE_WAVE', '2': 4},
    const {'1': 'POINTER_SHAPE_ANDROID', '2': 5},
    const {'1': 'POINTER_SHAPE_FLUTTER', '2': 6},
    const {'1': 'POINTER_SHAPE_AMONGUS', '2': 7},
  ],
};

/// Descriptor for `PointerSettingsMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pointerSettingsMessageDescriptor = $convert.base64Decode('');
